...
const Harvest = () => (
        <div style={{border:"1px solid #ECF0F1", backgroundColor:"#fff", width:"420px"}}>
            <div className="px-3 py-3">
                  <h4 className="mb-0">Harvest</h4>
                  <p className="mb-0">Operate with highest return on investment</p>
                </div>
                <div className="px-3">
                  <div
                  ...
                  <div
                    ...
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Hot-fix Process</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Inbound Marketing Plan</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Lead Nurture Process</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Referrals & Up-sales Plan</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Technology Revamp/Migration Plan</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Public Relations Activity Plan</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Contingency & Reliability Reviews</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Win-lose Analysis</p>
                  </div>
                </div>
