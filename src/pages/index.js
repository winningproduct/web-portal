              ...
              >
                ...
                <defs>
                  <radialGradient
                    ...
                    id="radialGradient-1"
                  >
                    <stop stop-color="#199A8E" offset="4%"></stop>
                    <stop stop-color="#7AF4AB" offset="100%"></stop>
                  </radialGradient>
                  <radialGradient
                    cx="96.6582524%"
                    cy="96.6527197%"
                    ...
                    id="radialGradient-2"
                  >
                    <stop stop-color="#0956C6" offset="4%"></stop>
                    <stop stop-color="#095BC8" offset="14%"></stop>
                    <stop stop-color="#0968CF" offset="25%"></stop>
                    <stop stop-color="#087FDB" offset="36%"></stop>
                    <stop stop-color="#079EEB" offset="48%"></stop>
                    <stop stop-color="#07A9F0" offset="52%"></stop>
                    <stop stop-color="#1EB1F2" offset="55%"></stop>
                    <stop stop-color="#42BEF5" offset="61%"></stop>
                    <stop stop-color="#5FC9F8" offset="68%"></stop>
                    <stop stop-color="#76D2FA" offset="74%"></stop>
                    <stop stop-color="#86D7FB" offset="81%"></stop>
                    <stop stop-color="#90DBFC" offset="89%"></stop>
                    <stop stop-color="#93DCFC" offset="100%"></stop>
                  </radialGradient>
                  <radialGradient
                    cx="127.874477%"
                    cy="74.2567393%"
                    ...
                    id="radialGradient-3"
                  >
                    <stop stop-color="#2B3894" offset="4%"></stop>
                  ...
                  <radialGradient
                    ...
                    id="radialGradient-4"
                  >
                    <stop stop-color="#C50048" offset="0%"></stop>
                    <stop stop-color="#6864B5" offset="100%"></stop>
                  </radialGradient>
                  <radialGradient
                    cx="72.1292896%"
                    cy="-12.1338912%"
                  ...
                  >
                    <stop stop-color="#C50048" offset="0%"></stop>
                    <stop stop-color="#E02B6A" offset="48%"></stop>
                    <stop stop-color="#FF5E93" offset="100%"></stop>
                  </radialGradient>
                  <radialGradient
                    cx="104.025105%"
                    cy="7.22750053%"
                  ...
                  <radialGradient
                    ...
                    id="radialGradient-7"
                  >
                    <stop stop-color="#FF9100" offset="4%"></stop>
                  ...
                  <radialGradient
                    ...
                    id="radialGradient-8"
                  >
                    <stop stop-color="#D8D9DD" offset="4%"></stop>
                    <stop stop-color="#EDEEF0" offset="55%"></stop>
                  ...
                  >
                    ...
                    <stop stop-color="#848484" stop-opacity="0.98" offset="30%"></stop>
                    <stop stop-color="#8B8B8B" stop-opacity="0.92" offset="47%"></stop>
                    <stop stop-color="#969697" stop-opacity="0.81" offset="60%"></stop>
                    <stop stop-color="#A6A6A7" stop-opacity="0.66" offset="72%"></stop>
                    <stop stop-color="#BBBCBD" stop-opacity="0.47" offset="83%"></stop>
                    <stop stop-color="#D4D5D7" stop-opacity="0.23" offset="92%"></stop>
                    <stop stop-color="#EDEEF0" stop-opacity="0" offset="100%"></stop>
                  </radialGradient>
                  <radialGradient
                    cx="8.7912822%"
                    cy="3.23011269%"
                  ...
                  <g id="Artboard" transform="translate(-404.000000, -234.000000)">
                    <g id="wheel-2" transform="translate(414.000000, 244.000000)">
                      <g id="wheel" transform="translate(43.921569, 43.921569)">
                        <g id="Group-3">
                          <g id="Segments-circle" transform="translate(0.451791, 0.000000)" fill-rule="nonzero">
                            <path
            ...
            <div>
              <div style={{border:"1px solid #ECF0F1", backgroundColor:"#fff", width:"420px"}}>
                <div className="px-3 py-3">
                  <h4 className="mb-0">Focus</h4>
                  <p className="mb-0">Select a specialization to target</p>
                </div>
                <div className="px-3">
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff;"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                  >
                    <p className="mb-0">Brand story development</p>
                  </div>
                  <div
                    style={{height: "36px", backgroundColor: "#2ECC71", color:"#fff;"}}
                    className="d-flex align-items-center mb-0 px-3 mb-2"
                ...
                <div className="py-3 mb-0 mt-5 text-center" style={{backgroundColor: "#34495E", color:"#fff"}}>
                  <p className="mb-0 text-center">LEARN FOCUS</p>
                </div>
              </div>
            </div>
          </div>
