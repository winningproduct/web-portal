      ...
      <div className="container">
                ...
                >
                  ...
                  >
                    <g id="wheel-new" transform="translate(0.508789, 0.000000)">
                      <g
                        id="center"
                        transform="translate(112.000000, 111.000000)"
                      >
                        <circle
                          id="Oval"
                          stroke="#8E44AD"
        ...
        <div className="row mt-5 mb-3">
          <div className="col-12 col-sm-12 mb-3">
            ...
            <p className="lead">
              Product management is different to bespoke application
              development. Learn how a specialized process keeps your product
              different from the competition. Our learning site has many
              strategic actions on this, here are some featured content areas.
            </p>
          </div>
          <div className="d-flex flex-row flex-wrap">
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                ...
                onClick={() =>
                  openLearnPortal("1-explore/05-value-proposition")
                }
              >
                <img
                  src={"../../VP.png"}
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() => openLearnPortal("2-focus/02-mvp-identification")}
              >
                <img
                  src={"../../MVP.png"}
                  alt="Focus – MVP identification image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() =>
                  openLearnPortal("2-focus/07-technical-architecture")
                }
              >
                <img
                  src={"../../TA.png"}
                  alt="Focus - Technical Architecture image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() =>
                  openLearnPortal("3-immerse/06-high-fidelity-prototype")
                }
              >
                <img
                  src={"../../HFP.png"}
                  alt="Immerse – High fidelity prototype image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() => openLearnPortal("4-plan/12-growth-hacking-plan")}
              >
                <img
                  src={"../../GHP.png"}
                  alt="Plan – Growth hacking plan image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() => openLearnPortal("4-plan/04-delivery-pipeline")}
              >
                <img
                  src={"../../DP.png"}
                  alt="Plan - Delivery Pipeline image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0  mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() =>
                  openLearnPortal("5-build/09-data-privacy-protection")
                }
              >
                <img
                  src={"../../DPP.png"}
                  alt="Build - Data Privacy Protection image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
            ...
            <div className="card col-12 col-sm-12 col-md-12 col-lg-4 mb-4 border-0 mb-4">
              <div
                className="col-12 col-sm-12 px-0 blogPreview"
                onClick={() =>
                  openLearnPortal("7-harvest/11-win-lose-analysis")
                }
              >
                <img
                  src={"../../WinLoss.png"}
                  alt="Harvest – Win-loss Analysis image"
                  style={{ width: "100%", height: "auto" }}
                />
                <div className="px-4 py-4">
        ...
        <div className="row my-5">
          <div className="col-12 col-sm-12 mb-3">
            ...
            <p className="lead">
              Our community has built a complete toolkit to help you nurture
              your product to a win over the competition.
            </p>
          </div>
